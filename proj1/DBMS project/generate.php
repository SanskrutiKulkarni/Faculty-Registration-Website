...
function generatePDF() {
    // Your code from 1st page.php
    if (isset($_POST['submit'])) {
        // Add your code here
    }

    // Your code from 2nd page.php
    if (isset($_POST['submit'])) {
        // Add your code here
    }

    // Continue with the rest of your code for generating PDF
    // Create new PDF instance
    $pdf = new TCPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);

    // Set document information
    $pdf->SetCreator('IIT Patna');
    $pdf->SetAuthor('Ravina Budania');
    $pdf->SetTitle('Application for Faculty Position');
    $pdf->SetSubject('Application Form');
    $pdf->SetKeywords('IIT Patna, Application, Faculty');
