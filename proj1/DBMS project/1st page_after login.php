...
if (isset($_POST['submit'])) {
    $advertisement_number = $_POST['adv_num'];
    $date_of_application = $_POST['doa'];
    $application_number = $_POST['ref_num'];
    $post_applied_for = $_POST['post'];
    $department_school = $_POST['dept'];
    ...
    $correspondence_street = $_POST['padd'];
    $correspondence_city = $_POST['padd1'];
    $correspondence_state = $_POST['padd2'];
    $correspondence_country = $_POST['padd3'];
    $correspondence_pin = $_POST['padd4'];
    $permanent_street = $_POST['padd'];
    $permanent_city = $_POST['padd1'];
    $permanent_state = $_POST['padd2'];
    $permanent_country = $_POST['padd3'];
    $permanent_pin = $_POST['padd4'];
    $mobile = $_POST['mobile'];
    $alternate_mobile = $_POST['mobile_2'];
    $email = $_POST['email'];
    $alternate_email = $_POST['email_2'];
    ...
    try {
        ...
        $stmt = $pdo->prepare("INSERT INTO PersonalDetails (
        ...
        // Bind parameters
        $stmt->bindParam(1, $advertisement_number);
        $stmt->bindParam(2, $date_of_application);
        $stmt->bindParam(3, $application_number);
        $stmt->bindParam(4, $post_applied_for);
        $stmt->bindParam(5, $department_school);
        $stmt->bindParam(6, $first_name);
        $stmt->bindParam(7, $middle_name);
        $stmt->bindParam(8, $last_name);
        $stmt->bindParam(9, $nationality);
        $stmt->bindParam(10, $date_of_birth);
        $stmt->bindParam(11, $gender);
        $stmt->bindParam(12, $marital_status);
        $stmt->bindParam(13, $category);
        $stmt->bindParam(14, $id_proof);
        $stmt->bindParam(15, $father_name);
        $stmt->bindParam(16, $correspondence_street);
        $stmt->bindParam(17, $correspondence_city);
        $stmt->bindParam(18, $correspondence_state);
        $stmt->bindParam(19, $correspondence_country);
        $stmt->bindParam(20, $correspondence_pin);
        $stmt->bindParam(21, $permanent_street);
        $stmt->bindParam(22, $permanent_city);
        $stmt->bindParam(23, $permanent_state);
        $stmt->bindParam(24, $permanent_country);
        $stmt->bindParam(25, $permanent_pin);
        $stmt->bindParam(26, $mobile);
        $stmt->bindParam(27, $alternate_mobile);
        $stmt->bindParam(28, $email);
        $stmt->bindParam(29, $alternate_email);
        $stmt->bindParam(30, $landline);
    ...
    header("Location: http://localhost/tuter/2nd%20page.php");
         ...
         <legend>
          ...
          <div class="row">
            ...
            <div class="col-md-3">
             ...
             <a href='#' class='btn btn-sm btn-info pull-right' onclick="get_username('Ravina&nbsp;Budania', 711)" data-target='#passModal' data-toggle='modal'>Change Password</a>
...
<div class="row">
  <div class="col-md-12">
      ...
      <select id="adv_num" name="adv_num" class="form-control input-md" required="">
          ...
          <!-- <option  value="IITP/FACREC-CHE/2024/JULY/02">IITP/FACREC-CHE/2024/JULY/02</option> -->
          <option  select='selected'value="IITP/FACREC-CHE/2024/April/07">IITP/FACREC-CHE/2024/April/07</option>
      ...
      <div class="col-md-4">
      <input id="doa" name="doa" type="text" readonly="readonly" value="09/09/24" placeholder="Date" class="form-control input-md" required="">
     </div>

      <label class="col-md-2 control-label" for="ref_num">Application Number</label>  
      <div class="col-md-4">

      <input id="ref_num" name="ref_num" type="text" readonly="readonly" value="16785423" placeholder="Application number" class="form-control input-md" required="">
     </div>
    ...
    <div class="row">
      <div class="col-md-12">
              ...
              <div class="col-md-10">
                <div class="row">
                  ...
                  <span class="col-md-2 control-label" for="fname">First Name *</span>  
                    <div class="col-md-4">
                    <input id="fname" value="Ravina" name="fname" type="text" placeholder="First name" class="form-control input-md" maxlength="15" required="">
                  </div>
                  ...
                  <span class="col-md-2 control-label" for="lname">Last Name *</span>  
                    <div class="col-md-4">
                    <input id="lname" value="Budania" name="lname"name="lname" type="text" placeholder="Last name" class="form-control input-md" maxlength="15" required="">
                    </div>
                ...
                <!-- </p> -->
                 ...
                 <!--  <span class="col-md-2 control-label" for="age">Age</span>  
                  ...
                  <div class="col-md-4"> 
                    <input id="cast" name="cast" type="text" placeholder="cast" readonly='readonly' value="OBC" class="form-control input-md" required="">
                  </div>
        ...
        <div class="col-md-2 pull-right">
                      <img src="https://t3.ftcdn.net/jpg/01/65/63/94/360_F_165639425_kRh61s497pV7IOPAjwjme1btB8ICkV0L.jpg" class="thumbnail pull-right" height="150" width="130" />
...
<div class="panel-body">
    <div class="row">
      <div class="col-md-6">
        <span class="control-label" for="padd">Correspondence Address </span>
        <br />
        <br />
...
<div class="col-md-12">
<a href="http://localhost/tuter/2nd%20page.php"><button id="submit" type="submit" name="submit" value="Submit" class="btn btn-success pull-right">SAVE & NEXT</button></a>
...
<form action="http://localhost/tuter/Login%20Page.php/" method="post">
