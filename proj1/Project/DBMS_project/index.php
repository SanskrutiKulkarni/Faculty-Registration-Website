...
if(isset($_POST['submit'])){
    if(isset($_POST['email']) && isset($_POST['password'])) {
        ...
        $conn = new mysqli('mysql', 'root', '12345', 'test', 3306);
        ...
        if ($result->num_rows == 1) {
            ...
            header("Location: http://localhost:8000/1st%20page_after%20login.php");
                ...
                <div class="col-md-10 col-md-offset-1">
                    ...
                    <form action="index.php" method="post" role="form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                            <a href="Forgot password.php"><button type="button" class="cancelbtn pull-right">Forgot Password</button></a>

                        </div>
                        </div>
                    </form>
                    <br />
                    <p style="text-align: center; color: rgb(125, 62, 96); font-size: 1.2em;"><strong>NOT REGISTERED? </strong> <a href='Sign Up Page.php' class="btn-sm btn-primary"> SIGN UP</a>
</p>
