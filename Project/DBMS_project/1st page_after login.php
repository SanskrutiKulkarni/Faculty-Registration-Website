...
if (isset($_POST['submit'])) {
    ...
    try {
        ...
        // Bind parameters
        $stmt->execute([$advertisement_number, $date_of_application, $application_number, $post_applied_for, $department_school, $first_name, $middle_name, $last_name, $nationality, $date_of_birth, $gender, $marital_status, $category, $id_proof, $father_name, $correspondence_street, $correspondence_city, $correspondence_state, $correspondence_country, $correspondence_pin, $permanent_street, $permanent_city, $permanent_state, $permanent_country, $permanent_pin, $mobile, $alternate_mobile, $email, $alternate_email, $landline]);

        echo "Data inserted successfully!";
        
        // Redirect to the next page
        header("Location: http://localhost:8000/2nd%20page.php");
        exit();
    ...
    <fieldset>
         ...
         <legend>
          ...
          <div class="row">
            ...
            <div class="col-md-1">
              <a href="http://localhost:8000/" class="btn btn-sm btn-success  pull-right">Logout</a>
            </div>
          </div>
...
<div class="col-md-12">
<a href="http://localhost:8000/2nd%20page.php"><button id="submit" type="submit" name="submit" value="Submit" class="btn btn-success pull-right">SAVE & NEXT</button></a>
